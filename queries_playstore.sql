...
--  SELECT app_name, reviews, min_installs, (CAST(min_installs AS decimal)/ reviews) AS proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;